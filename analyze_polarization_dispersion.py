...
for space in spacing:
    ...
    sigma_phi_1 = get_polarization_dispersion(data_256_1)
    sigma_phi_2 = get_polarization_dispersion(data_256_2)
    sigma_phi_3 = get_polarization_dispersion(data_256_3)
    sigma_phi_4 = get_polarization_dispersion(data_256_4)

    sigma_phi_5 = get_polarization_dispersion(data_256_5)
    sigma_phi_6 = get_polarization_dispersion(data_256_6)
    sigma_phi_7 = get_polarization_dispersion(data_256_7)
    sigma_phi_8 = get_polarization_dispersion(data_256_8)

    sigma_phi_9 = get_polarization_dispersion(data_256_9)
    sigma_phi_10 = get_polarization_dispersion(data_256_10)
    sigma_phi_11 = get_polarization_dispersion(data_256_11)
    sigma_phi_12 = get_polarization_dispersion(data_256_12)
...
plt.scatter(alfven_speed_low_b_high_g / iso_speed, case_1, color="black", marker="o", label=f'weak B, g = 1.0')
plt.scatter(alfven_speed_low_mid_b_high_g / iso_speed, case_2,  color="tab:blue", marker="o", label=f'weak-mid B, g = 1.0')
plt.scatter(alfven_speed_mid_b_high_g / iso_speed, case_3,  color="tab:green", marker="o", label=f'mid B, g = 1.0')
plt.scatter(alfven_speed_high_b_high_g / iso_speed, case_4, color="tab:red", marker="o", label=f'strong B, g = 1.0')

plt.scatter(alfven_speed_low_b_low_g / iso_speed, case_5, color="black", marker="*", label=f'weak B, g = 0.1')
plt.scatter(alfven_speed_low_mid_b_low_g / iso_speed, case_6, color="tab:blue", marker="*", label=f'weak-mid B, g = 0.1')
plt.scatter(alfven_speed_mid_b_low_g / iso_speed, case_7,  color="tab:green", marker="*", label=f'mid B, g = 0.1')
plt.scatter(alfven_speed_high_b_low_g / iso_speed, case_8, color="tab:red", marker="*", label=f'strong B, g = 0.1')

plt.scatter(alfven_speed_low_b_uni_g / iso_speed, case_9, color="black", marker="+", label=f'weak B, uniform')
plt.scatter(alfven_speed_low_mid_b_uni_g / iso_speed, case_10,  color="tab:blue", marker="+", label=f'weak-mid B, uniform')
plt.scatter(alfven_speed_mid_b_uni_g / iso_speed, case_11,  color="tab:green", marker="+", label=f'mid B, uniform')
plt.scatter(alfven_speed_high_b_uni_g / iso_speed, case_12, color="tab:red", marker="+", label=f'strong B, uniform')

# Labels
plt.xlabel(r"$v_a / c_s$", fontsize=8)
plt.ylabel(r"polarization dispersion $\,(\delta \theta)$", fontsize=8)
...
plt.savefig("polarization_disperion_3Myr.pdf", bbox_inches="tight")
