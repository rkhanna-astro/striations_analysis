...
for space in spacing:
    ...
    case_1.append(sigma_vel_1)
    case_2.append(sigma_vel_2)
    case_3.append(sigma_vel_3)
    case_4.append(sigma_vel_4)

    case_5.append(sigma_vel_5)
    case_6.append(sigma_vel_6)
    case_7.append(sigma_vel_7)
    case_8.append(sigma_vel_8)

    case_9.append(sigma_vel_9)
    case_10.append(sigma_vel_10)
    case_11.append(sigma_vel_11)
    case_12.append(sigma_vel_12)
...
plt.ylabel(r"velocity dispersion $\,(\sigma_v_{x})$", fontsize=8)
...
plt.savefig("velocity_disperion_3Myr.pdf", bbox_inches="tight")
